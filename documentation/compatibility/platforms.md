...
| PLATFORM-LINUX-HEADLESS | `Linux headless` | supported | Bundles and mounts the semantic View/Text fixture without a display server. | [smoke gate](../../samples/view-text/smoke/smoke_gate.gd) | [BASELINE-SMOKE](test-coverage.md) |
