...
This matrix distinguishes implemented subsets from behavior covered by automated tests.
Partially supported rows may rely on source evidence when test evidence is `none`.
...
| STYLE-BORDER-CURVE | `borderCurve` | pending | Public border curve key has no Godot behavior or automated coverage. | none | none |
| STYLE-BORDER-STYLE | `borderStyle` | pending | Public border style key has no Godot behavior or automated coverage. | none | none |
| STYLE-ELEVATION | `elevation` | pending | Public elevation key has no Godot behavior or automated coverage. | none | none |
...
| STYLE-TEXT-TYPOGRAPHY | `fontFamily/fontStyle/fontWeight/fontVariant` | pending | Public typography keys have no Godot behavior or automated coverage. | none | none |
...
| STYLE-TEXT-ALIGNMENT | `textAlign/textAlignVertical` | pending | Public text alignment keys have no Godot behavior or automated coverage. | none | none |
...
| STYLE-TEXT-OTHER | `includeFontPadding/textTransform/userSelect/verticalAlign/writingDirection` | pending | Public text keys have no Godot behavior or automated coverage. | none | none |
