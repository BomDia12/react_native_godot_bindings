...
| STYLE-FLEX | `flex` | partially supported | Numeric flex fills the baseline root; broader shorthand semantics are not covered. | [layout](../../modules/react_native_bindings/fabric/rn_layout.cpp) | [BASELINE-SMOKE](test-coverage.md) |
...
| STYLE-PADDING | `padding*` | partially supported | Numeric padding affects the baseline tree; percent and per-edge variants lack coverage. | [layout](../../modules/react_native_bindings/fabric/rn_layout.cpp) | [BASELINE-SMOKE](test-coverage.md) |
